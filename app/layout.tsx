...
export const metadata: Metadata = {
  ...
  title: "Archers Calendar - Free Calendar & Schedule Generator for Students",
  description: "The ultimate free calendar and schedule generator for PH students. Build a custom schedule wallpaper in 30 seconds by pasting your classes. Support for iPhone, iPad, MacBook, and Laptop. Export as high-res wallpapers or clear PNGs. 100% FREE. Created by Richard Christian Uaje.",
  keywords: [
    "calendar generator", "schedule generator", "schedule wallpaper generator", "PH student tools", 
    "class schedule builder", "university schedule maker", "iPhone schedule wallpaper", 
    "iPad schedule wallpaper", "MacBook schedule wallpaper", "free student app",
  ...
  openGraph: {
    title: "Archers Calendar - Free Calendar & Schedule Generator",
    description: "Build beautiful, high-res schedule wallpapers in seconds. 100% FREE for all PH universities. Created by Richard Christian Uaje.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Archers Calendar - Free Calendar Generator",
      },
    ],
    locale: "en_PH",
    type: "website",
  ...
  twitter: {
    ...
    title: "Archers Calendar - 30-Second Schedule Generator",
    description: "Convert your university schedule into aesthetic wallpapers. 100% FREE. Created by Richard Christian Uaje.",
